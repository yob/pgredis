...
func (cmd *hgetCommand) Execute(command *redisproto.Command, redis *PgRedis) pgRedisValue {
	key := command.Get(1)
	field := command.Get(2)
...
func (cmd *hmgetCommand) Execute(command *redisproto.Command, redis *PgRedis) pgRedisValue {
	key := command.Get(1)
...
func (cmd *hgetallCommand) Execute(command *redisproto.Command, redis *PgRedis) pgRedisValue {
	key := command.Get(1)
...
func (cmd *hmsetCommand) Execute(command *redisproto.Command, redis *PgRedis) pgRedisValue {
...
func (cmd *hsetCommand) Execute(command *redisproto.Command, redis *PgRedis) pgRedisValue {
	key := command.Get(1)
	field := command.Get(2)
	value := command.Get(3)
